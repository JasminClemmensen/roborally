...
public class Board extends Subject {
    ...
    /**
     * Number of players in the game on this board.
     *
    ...
    public String getStatusMessage() {
        ...
        return "Phase: " + getPhase().name() +
                ", Player = " + getCurrentPlayer().getName() + ", number of moves: " + getCount();
    }


    /**
     * Counts er de numre for bevægelser i spillet.
     * Så snart man bruger subject og der ændres noget, så skal der står "notifyChange();"
     */
    private int count;
    ...
    public void setCount(int count) {
        if (this.count != count) {
            this.count = count;
            notifyChange(); // hvis man glemmer og skrive den ind i kode der ændrer noget, så bliver den ikke vist af GUI
        }
    }
}
